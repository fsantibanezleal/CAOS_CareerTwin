...
2. Choose exactly one capture mode: URL, file, paste, or manual.
...
4. For documents, keep the file within upload limits and supported formats. The production scanner must pass before extraction.
