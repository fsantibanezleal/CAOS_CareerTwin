...
Version `0.5.9` carries the decision-grade guided experience and accessible dynamic-visualization
...
labels that avoid dense cluster collisions while full entity text remains inspectable. The
