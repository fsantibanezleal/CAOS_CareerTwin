...
Version `0.5.8` carries the decision-grade guided experience and accessible dynamic-visualization
...
retain readable active light or dark workbench tokens, with bounded overview labels that avoid dense
cluster collisions while full entity text remains inspectable. The
